...
module.exports = {
    ...
    run: async (client, message, args, prefix) => {
        ...
        client.setups.set(message.guild.id, !client.setups.get(message.guild.id, "ticketsystem_general.enabled"), "ticketsystem_general.enabled")
        return message.reply(`> ✅ **The General Ticket Support is now: \`${client.setups.get(message.guild.id, "ticketsystem_general.enabled") ? "Enabled" : "Disabled"}\`**`)
    }
}