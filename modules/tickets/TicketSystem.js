...
module.exports = client => {
            ...
            for(const deleteChannel of toDeleteChannels.map(d => d.channel)) {
                ...
                if(channel) {
                    ...
                    try {
                        ...
                        /*if (!userid && channel.parent && channel.parent.id == `${mainconfig.TicketCategorys.TicketsAllCategoty}`)
                        ...
                        if (!userid && channel.parent && channel.parent.id == `${mainconfig.TicketCategorys.TicketsAllCategoty}`)
                            userid = client.setups.findKey(user => user.ticketid7 == channel.id)
                        if (!userid && channel.parent && channel.parent.id == `${mainconfig.TicketCategorys.TicketsAllCategoty}`)
                            userid = client.setups.findKey(user => user.ticketid8 == channel.id)
                        if (!userid && channel.parent && channel.parent.id == `${mainconfig.TicketCategorys.TicketsAllCategoty}`)
                            userid = client.setups.findKey(user => user.ticketid9 == channel.id)
                        if (!userid && channel.parent && channel.parent.id == `${mainconfig.TicketCategorys.TicketsAllCategoty}`)
                            userid = client.setups.findKey(user => user.ticketid10 == channel.id)
                        if (!userid && channel.parent && channel.parent.id == `${mainconfig.TicketCategorys.TicketsAllCategoty}`)
                            userid = client.setups.findKey(user => user.ticketid10 == channel.id)*/
                        if (!userid && channel.parent && channel.parent.id == `${mainconfig.TicketCategorys.TicketsAllCategoty}`)
                            userid = client.setups.findKey(user => user.ticketid11 == channel.id)
                        if (!userid && channel.parent && channel.parent.id == `${mainconfig.TicketCategorys.TicketsAllCategoty}`)
                            userid = client.setups.findKey(user => user.ticketid12 == channel.id)
                        if (!userid && channel.parent && channel.parent.id == `${mainconfig.TicketCategorys.TicketsAllCategoty}`)
                            userid = client.setups.findKey(user => user.ticketid13 == channel.id)
                        if (!userid && channel.parent && channel.parent.id == `${mainconfig.TicketCategorys.TicketsAllCategoty}`)
                            userid = client.setups.findKey(user => user.ticketid14 == channel.id)
                        if (!userid && channel.parent && channel.parent.id == `${mainconfig.ApplyTickets.StaffApply}`)
                            userid = client.setups.findKey(user => user.ticketid_teamapply == channel.id)
                        if (!userid && channel.parent && channel.parent.id == `${mainconfig.ApplyTickets.PartnerApply}`)
                            userid = client.setups.findKey(user => user.ticketid_partnerapply == channel.id)
                            ...
                            userid = client.setups.findKey(user => user.ticketid == channel.id 
                                ...
                                || user.ticketid11 == channel.id
                                || user.ticketid12 == channel.id
                                || user.ticketid13 == channel.id
                                || user.ticketid14 == channel.id
                                || user.ticketid_teamapply == channel.id
                                || user.ticketid_partnerapply == channel.id)
                        }
                    } catch (e) {
                    ...
                    let parent1 = message.guild.channels.cache.get(`${mainconfig.TicketCategorys.TicketsAllCategoty}`);
                    let parent2 = message.guild.channels.cache.get(`${mainconfig.TicketCategorys.TicketsAllCategoty}`)
                    let parent3 = message.guild.channels.cache.get(`${mainconfig.TicketCategorys.TicketsAllCategoty}`)
                    let parent4 = message.guild.channels.cache.get(`${mainconfig.TicketCategorys.TicketsAllCategoty}`)
                    let parent5 = message.guild.channels.cache.get(`${mainconfig.TicketCategorys.TicketsAllCategoty}`)
                    let parent6 = message.guild.channels.cache.get(`${mainconfig.TicketCategorys.TicketsAllCategoty}`)
                    let parent7 = message.guild.channels.cache.get(`${mainconfig.TicketCategorys.TicketsAllCategoty}`)
                    let parent8 = message.guild.channels.cache.get(`${mainconfig.TicketCategorys.TicketsAllCategoty}`)
                    let parent9 = message.guild.channels.cache.get(`${mainconfig.TicketCategorys.TicketsAllCategoty}`)
                                    ...
                                    try {
                                        await client.users.fetch(userid).then(async user => {
                                            try {
                                                ...
                                                if (channel.parent && channel.parent.id == `${mainconfig.TicketCategorys.AllShopTicketCategory}`)
            ...
            setTimeout(async() => {
                if(channel) {
                    ...
                    try {
                        ...
                        /*if (!userid && channel.parent && channel.parent.id == `${mainconfig.TicketCategorys.AllShopTicketCategory}`)
                            userid = client.setups.findKey(user => user.ticketid == channel.id)
                        if (!userid && channel.parent && channel.parent.id == `${mainconfig.TicketCategorys.AllShopTicketCategory}`)
                            userid = client.setups.findKey(user => user.ticketid2 == channel.id)
                        if (!userid && channel.parent && channel.parent.id == `${mainconfig.TicketCategorys.AllShopTicketCategory}`)
                    ...
                    let parent1 = channel.guild.channels.cache.get(`${mainconfig.TicketCategorys.AllShopTicketCategory}`);
                    let parent2 = channel.guild.channels.cache.get(`${mainconfig.TicketCategorys.AllShopTicketCategory}`);
    ...
    if (!interaction.isSelectMenu()) return;
        if (interaction.message.channel.id == TicketChannelID) {
            let menuIndex = settings.ticketsystem.find(v => String(v.value).split(" ").join("").substring(0, 25) == String(interaction.values[0]).split(" ").join("").substring(0, 25));
            ...
            if(menuIndex.type){
                ...
                switch(menuIndex.type){
                    ...
                    > The <@&935689419757854780> will try to help you with your Bot Problem as soon as possible!`, "ticketsystem4.message");
                        let ticket = client.setups.get(guild.id, "ticketsystem_help");
                        ...
                        if (client.setups.get("TICKETS", "tickets11").includes(user.id)) {
                            ...
                            if(!ch || ch == null || !ch.id || ch.id == null || [`${mainconfig.TicketCategorys.AllShopTicketCategory}`, `${mainconfig.TicketCategorys.AllShopTicketCategory}`].includes(ch.parentId)){
                                client.setups.remove("TICKETS", user.id, "tickets11")
                            }
                            else{
                                stopped = true;
                                return interaction.editReply(":x: **You already have an opened Ticket!** <#" + client.setups.get(user.id, "ticketid11") + ">");
                            }
                            }catch{
                        ...
                        */
                         ...
                         guild.channels.create(channelname.substring(0, 32), {
                            parent: `${mainconfig.TicketCategorys.TicketsAllCategoty}`,
                        ...
                        components: [
                            ...
                            if(interaction.message.channel.id == TicketChannelID) msg.reply(`<:Approved:1079215640944070697>  **Please read this completely**`).catch(() => {});
                        })
                    ...
                    case "GENERAL" : {
                        ...
                        let ticket = client.setups.get(guild.id, "ticketsystem_general");
                        if (!ticket.enabled) return interaction.editReply(":x: **Sorry but the Ticket System got temporarily disabled!**").catch(e => console.warn(e.stack ? String(e.stack).grey : String(e).grey));
                        var stopped = false;
                        if (client.setups.get("TICKETS", "tickets12").includes(user.id)) {
                            ...
                            if(!ch || ch == null || !ch.id || ch.id == null || [`${mainconfig.TicketCategorys.AllShopTicketCategory}`, `${mainconfig.TicketCategorys.AllShopTicketCategory}`].includes(ch.parentId)){
                                ...
                                stopped = true;
                                return interaction.editReply(":x: **You already have an opened Ticket!** <#" + client.setups.get(user.id, "ticketid12") + ">");
                            }
                            }catch{
                        ...
                        guild.channels.create(channelname.substring(0, 32), {
                            ...
                            client.setups.set(ch.id, user.id, "user");
                            ch.send({content: `<@${user.id}> <:arrow:1079211960199028796> ${ticket.adminroles.map(r => `<@&${r}>`).join(" | ")} ${emoji.arrow_left}`, embeds: [ new MessageEmbed().setColor("#6861fe").setTitle("📂 Thanks for opening a Ticket | What do you need?").setDescription(ticket.message.replace("{user}", `${user}`)),
                                new MessageEmbed().setColor("ORANGE").setTitle(`${emoji.loading}  A Staff Member will claim the Ticket soon!`).setDescription(`**Dear ${user}!**\n> This Ticket will be claimed by a Staff Member as soon as possible!\n\n> *He/She/They will help you then!*\n\n> **Meanwhile, make sure to list us all Information needed!**`).setFooter("Thanks for choosing Team Arcades ✌️", "https://i.imgur.com/UnHkdfP.png")],
                            components: [
                                new MessageActionRow().addComponents([
                    ...
                    case "TEAMAPPLY" : {
                        await interaction.reply({content: `<:Editing:1079215655947092048> Creating your Ticket ... `, ephemeral: true})
                        Cooldown.set(user.id, Date.now())
                        setTimeout(()=>Cooldown.delete(user.id), cooldownamount);
                        ////////////////////////
                        /////////////////////////
                        ...
                        guild.channels.create(channelname.substring(0, 32), {
                            parent: `${mainconfig.ApplyTickets.StaffApply}`,
                            topic: `ticket-${user.id}`
                        }).then(ch => {
                            ch.permissionOverwrites.edit(guild.roles.everyone, { //disabling all roles
                                SEND_MESSAGES: false,
                            ...
                            client.setups.set(ch.id, user.id, "user");
                            ch.send({content: `<@${user.id}> <:arrow:1079211960199028796> ${ticket.adminroles.map(r => `<@&${r}>`).join(" | ")} ${emoji.arrow_left}`, embeds: [ new MessageEmbed().setColor("#6861fe").setTitle("📂 Thanks for opening an Application | Tell us something about you!").setDescription(ticket.message.replace("{user}", `${user}`)),
                                new MessageEmbed().setColor("ORANGE").setTitle(`${emoji.loading}  A Staff Member will claim the Ticket soon!`).setDescription(`**Dear ${user}!**\n> This Ticket will be claimed by a Staff Member as soon as possible!\n\n> *He/She/They will help you then!*\n\n> **Meanwhile, make sure to list us all Information needed!**`).setFooter("Thanks for choosing Team Arcades ✌️", "https://i.imgur.com/UnHkdfP.png")],
                            components: [
                                new MessageActionRow().addComponents([
                                    new MessageButton().setStyle("PRIMARY").setLabel("Claim").setEmoji("📝").setCustomId("TicketClaim")
                    ...
                    case "PARTNERAPPLY" : {
                        await interaction.reply({content: `<:Partner:1079215681784000522> Creating your Ticket ... `, ephemeral: true})
                        Cooldown.set(user.id, Date.now())
                        setTimeout(()=>Cooldown.delete(user.id), cooldownamount);
                        ////////////////////////
                        /////////////////////////
                        ...
                        guild.channels.create(channelname.substring(0, 32), {
                            parent: `${mainconfig.ApplyTickets.PartnerApply}`,
                            topic: `ticket-${user.id}`
                        }).then(ch => {
                            ch.permissionOverwrites.edit(guild.roles.everyone, { //disabling all roles
                                SEND_MESSAGES: false,
                            ...
                            client.setups.set(ch.id, user.id, "user");
                            ch.send({content: `<@${user.id}> <:arrow:1079211960199028796> ${ticket.adminroles.map(r => `<@&${r}>`).join(" | ")} ${emoji.arrow_left}`, embeds: [ new MessageEmbed().setColor("#6861fe").setTitle("📂 Thanks for opening an Partner-Application | Tell us something about you!").setDescription(ticket.message.replace("{user}", `${user}`)),
                                new MessageEmbed().setColor("ORANGE").setTitle(`${emoji.loading}  A Staff Member will claim the Ticket soon!`).setDescription(`**Dear ${user}!**\n> This Ticket will be claimed by a Staff Member as soon as possible!\n\n> *He/She/They will help you then!*\n\n> **Meanwhile, make sure to list us all Information needed!**`).setFooter("Thanks for choosing Team Arcades ✌️", "https://i.imgur.com/UnHkdfP.png")],
                            components: [
                                new MessageActionRow().addComponents([
                                    new MessageButton().setStyle("PRIMARY").setLabel("Claim").setEmoji("📝").setCustomId("TicketClaim")
                    ...
                    case "CUSTOMBOT" : {
                        ...
                        await interaction.reply({content: `<:Bot_Flag:1079211968944156804> Creating your Custom-Bot-Ordering-Ticket ... `, ephemeral: true})
                        ////////////////////////
                        /////////////////////////
                        
                        let ticket = client.setups.get(guild.id, "ticketsystem_custom");
                        ...
                        if (client.setups.get("TICKETS", "tickets13").includes(user.id)) {
                            ...
                            if(!ch || ch == null || !ch.id || ch.id == null || [`${mainconfig.TicketCategorys.AllShopTicketCategory}`, `${mainconfig.TicketCategorys.AllShopTicketCategory}`].includes(ch.parentId)){
                                ...
                                stopped = true;
                                return interaction.editReply(":x: **You already have an custom Bot Order!** <#" + client.setups.get(user.id, "ticketid13") + ">");
                            }
                            }catch{
                        ...
                        guild.channels.create(channelname.substring(0, 32), {
                            parent: `${mainconfig.TicketCategorys.CustomBotsTicketCategory}`,
                            topic: `ticket-${user.id}`
                        }).then(ch => {
                            ch.permissionOverwrites.edit(guild.roles.everyone, { //disabling all roles
                                SEND_MESSAGES: false,
                            ...
                            client.setups.set(ch.id, user.id, "user");
                            ch.send({content: `<@${user.id}> <:arrow:1079211960199028796> ${ticket.adminroles.map(r => `<@&${r}>`).join(" | ")} ${emoji.arrow_left}`, embeds: [ new MessageEmbed().setColor("#6861fe").setTitle("📂 Thanks for ordering a Custom Bot!").setDescription(ticket.message.replace("{user}", `${user}`)),
                                new MessageEmbed().setColor("ORANGE").setTitle(`${emoji.loading}  A Staff Member will claim the Ticket soon!`).setDescription(`**Dear ${user}!**\n> This Ticket will be claimed by a Staff Member as soon as possible!\n\n> *He/She/They will help you then!*\n\n> **Meanwhile, make sure to list us all Information needed!**`).setFooter("Thanks for choosing Team Arcades ✌️", "https://i.imgur.com/UnHkdfP.png")],
                            components: [
                                new MessageActionRow().addComponents([
                                    new MessageButton().setStyle("PRIMARY").setLabel("Claim").setEmoji("📝").setCustomId("TicketClaim")
                    ...
                    //ticketsystem_source
                    case "SOURCECODE" : {
                        await interaction.reply({content: `<a:Valid_Code_Developer:1079211977395683368> Creating your Source-Code-Ordering-Ticket ... `, ephemeral: true})

                        let ticket = client.setups.get(guild.id, "ticketsystem_source");
                        ...
                        var stopped = false;
                        if (client.setups.get("TICKETS", "tickets14").includes(user.id)) {
                            try{
                            let ch = guild.channels.cache.get(client.setups.get(user.id, "ticketid14"));
                            if(!ch || ch == null || !ch.id || ch.id == null || [`${mainconfig.TicketCategorys.AllShopTicketCategory}`, `${mainconfig.TicketCategorys.AllShopTicketCategory}`].includes(ch.parentId)){
                                client.setups.remove("TICKETS", user.id, "tickets14")
                            }
                            else{
                                stopped = true;
                                return interaction.editReply(":x: **You already have an opened Ticket!** <#" + client.setups.get(user.id, "ticketid14") + ">");
                            }
                            }catch{
                        ...
                        guild.channels.create(channelname.substring(0, 32), {
                            parent: `${mainconfig.OwnerInformation.OwnerTicketCat}`,
                            topic: `ticket-${user.id}`
                        }).then(ch => {
                            ch.permissionOverwrites.edit(guild.roles.everyone, { //disabling all roles
                                SEND_MESSAGES: false,
                            ...
                            client.setups.push("TICKETS", user.id, "tickets14");
                            client.setups.set(user.id, ch.id, "ticketid14");
                            client.setups.set(ch.id, user.id, "user");
                            ch.send({content: `<@${user.id}> <:arrow:1079211960199028796> ${ticket.adminroles.map(r => `<@&${r}>`).join(" | ")} ${emoji.arrow_left}`, embeds: [ new MessageEmbed().setColor("#6861fe").setTitle("📂 Thanks for ordering a Source Code!").setDescription(ticket.message.replace("{user}", `${user}`)),
                                new MessageEmbed().setColor("ORANGE").setTitle(`${emoji.loading}  A Staff Member will claim the Ticket soon!`).setDescription(`**Dear ${user}!**\n> This Ticket will be claimed by a Staff Member as soon as possible!\n\n> *He/She/They will help you then!*\n\n> **Meanwhile, make sure to list us all Information needed!**`).setFooter("Thanks for choosing Team Arcades ✌️", "https://i.imgur.com/UnHkdfP.png")],
                            components: [
                                new MessageActionRow().addComponents([
                                    new MessageButton().setStyle("PRIMARY").setLabel("Claim").setEmoji("📝").setCustomId("TicketClaim")
                            ...
                            interaction.editReply({content: `<#${ch.id}>`, embeds: [ 
                                new MessageEmbed()
                                .setColor("#6861fe")
