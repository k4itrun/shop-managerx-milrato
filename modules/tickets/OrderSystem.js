...
module.exports = client => {
                ...
                if(channel) {
                    ...
                    try {
                        ...
                        if (!userid && message.channel.parent && message.channel.parent.id == `${mainconfig.TicketCategorys.ClosedAllTicketCategoty}`)
                            userid0 = client.setups.findKey(user => user.ticketid == message.channel.id)
                        if (!userid0 && message.channel.parent && message.channel.parent.id == `${mainconfig.TicketCategorys.MusicBotOrderCategory}`)
                            userid2 = client.setups.findKey(user => user.ticketid2 == message.channel.id)
                        if (!userid2 && message.channel.parent && message.channel.parent.id == `${mainconfig.TicketCategorys.RythmBotTicketsCategory}`)
                            userid3 = client.setups.findKey(user => user.ticketid3 == message.channel.id)
                        if (!userid3 && message.channel.parent && message.channel.parent.id == `${mainconfig.TicketCategorys.LightMusicBotOrderCategory}`)
                            userid4 = client.setups.findKey(user => user.ticketid4 == message.channel.id)
                        if (!userid4 && message.channel.parent && message.channel.parent.id == `${mainconfig.TicketCategorys.AdminBotTicketsCategory}`)
                            userid5 = client.setups.findKey(user => user.ticketid5 == message.channel.id)
                        if (!userid5 && message.channel.parent && message.channel.parent.id == `${mainconfig.TicketCategorys.MusicBotOrderCategory}`)
                            userid6 = client.setups.findKey(user => user.ticketid6 == message.channel.id)
                        if (!userid6 && message.channel.parent && message.channel.parent.id == `${mainconfig.TicketCategorys.ModMailBotTicketsCategory}`)
                            userid7 = client.setups.findKey(user => user.ticketid7 == message.channel.id)
                        if (!userid7 && message.channel.parent && message.channel.parent.id == `${mainconfig.TicketCategorys.MusicBotOrderCategory}`)
                            userid8 = client.setups.findKey(user => user.ticketid8 == message.channel.id)
                        if (!userid8 && message.channel.parent && message.channel.parent.id == `${mainconfig.TicketCategorys.SecurityTicketsCategory}`)
                            userid9 = client.setups.findKey(user => user.ticketid9 == message.channel.id)
                        if (!userid9 && message.channel.parent && message.channel.parent.id == `${mainconfig.TicketCategorys.NsfwFunBotTicketsCategory}`)
                            userid10 = client.setups.findKey(user => user.ticketid10 == message.channel.id)
                        if (!userid10 && message.channel.parent && message.channel.parent.id == `${mainconfig.TicketCategorys.NsfwFunBotTicketsCategory}`)
                                ...
                                if (userid && userid.length > 2) {
                                    try {
                                        await client.users.fetch(userid).then(async user => {
                                            try {
                                                if (channel.parent && channel.parent.id == `${mainconfig.TicketCategorys.SystemBotOrderCategory}`)
                                                    client.setups.remove("TICKETS", user.id, "tickets");
                                                if (channel.parent && channel.parent.id == `${mainconfig.TicketCategorys.MusicBotOrderCategory}`)
                                                    client.setups.remove("TICKETS", user.id, "tickets2");
                                                if (channel.parent && channel.parent.id == `${mainconfig.TicketCategorys.RythmBotTicketsCategory}`)
                                                    client.setups.remove("TICKETS", user.id, "tickets3");
                                                if (channel.parent && channel.parent.id == `${mainconfig.TicketCategorys.LightMusicBotOrderCategory}`)
                                                    client.setups.remove("TICKETS", user.id, "tickets4");
                                                if (channel.parent && channel.parent.id == `${mainconfig.TicketCategorys.AdminBotTicketsCategory}`)
                                                ...
                                                if (channel.parent && channel.parent.id == `${mainconfig.TicketCategorys.SecurityTicketsCategory}`)
                                                    client.setups.remove("TICKETS", user.id, "tickets9");
                                                if (channel.parent && channel.parent.id == `${mainconfig.TicketCategorys.NsfwFunBotTicketsCategory}`)
                    ...
                    if(parent1 && parent1.type == "GUILD_CATEGORY" && parent1.children.size < 50) {
                        ...
                        await channel.setParent(parent6.id, {lockPermissions:false}).catch(()=>{});
                    } else if(parent7 && parent7.type == "GUILD_CATEGORY" && parent7.children.size < 50) {
                        await channel.setParent(parent7.id, {lockPermissions:false}).catch(()=>{});
                    } else if(parent8 && parent8.type == "GUILD_CATEGORY" && parent8.children.size < 50) {
                        await channel.setParent(parent8.id, {lockPermissions:false}).catch(()=>{});
                    } else if(parent9 && parent9.type == "GUILD_CATEGORY" && parent9.children.size < 50) {
                        await channel.setParent(parent9.id, {lockPermissions:false}).catch(()=>{});
                    } else if(parent10 && parent10.type == "GUILD_CATEGORY" && parent10.children.size < 50) {
                        await channel.setParent(parent10.id, {lockPermissions:false}).catch(()=>{});
                    }
        ...
        if(interaction.customId == "closeticket"){
            ...
            setTimeout(async() => {
                if(channel) {
                    ...
                    let parent1 = channel.guild.channels.cache.get(`${mainconfig.TicketCategorys.SystemBotOrderCategory}`);
                    let parent2 = channel.guild.channels.cache.get(`${mainconfig.TicketCategorys.MusicBotOrderCategory}`);
                    let parent3 = channel.guild.channels.cache.get(`${mainconfig.TicketCategorys.RythmBotTicketsCategory}`);
                    let parent4 = channel.guild.channels.cache.get(`${mainconfig.TicketCategorys.LightMusicBotOrderCategory}`);
                    let parent5 = channel.guild.channels.cache.get(`${mainconfig.TicketCategorys.AdminBotTicketsCategory}`);
                    let parent6 = channel.guild.channels.cache.get(`${mainconfig.TicketCategorys.MusicBotOrderCategory}`);
                    let parent7 = channel.guild.channels.cache.get(`${mainconfig.TicketCategorys.ModMailBotTicketsCategory}`);
                    let parent8 = channel.guild.channels.cache.get(`${mainconfig.TicketCategorys.MusicBotOrderCategory}`);
                    let parent9 = channel.guild.channels.cache.get(`${mainconfig.TicketCategorys.SecurityTicketsCategory}`);
                    let parent10 = channel.guild.channels.cache.get(`${mainconfig.TicketCategorys.NsfwFunBotTicketsCategory}`);
                    
                    if( parent1 && parent1.size > 50 && 
                        parent2 && parent2.size > 50 && 
                        parent3 && parent3.size > 50 && 
                        parent4 && parent4.size > 50 && 
                        parent5 && parent5.size > 50 && 
                        parent6 && parent6.size > 50 && 
                        parent7 && parent7.size > 50 && 
                        parent8 && parent8.size > 50 && 
                        parent9 && parent9.size > 50 && 
                        parent10 && parent10.size > 50 ){
                        channel.delete().catch(console.warn);
                    }
    ...
    client.on('interactionCreate', async interaction => {
        if (!interaction.isButton()) return;
        if (interaction.message.channel.id == RecoverChannelId || interaction.message.channel.id == OrderChannelID) {
            interaction.reply({content: `<a:check:1079215644274335834> **Ping Successful!** You can now Open a Ticket!`, ephemeral: true})
        }
    })
    client.on('interactionCreate', async interaction => {
        ...
        if (interaction.message.channel.id == RecoverChannelId || interaction.message.channel.id == OrderChannelID) {
            ...
            if(menuIndex.type){
                ...
                switch(menuIndex.type){
                    case "SYSTEMBOTS" : {
                        await interaction.reply({content: `<a:Loading:1075485750000361523> **Creating Your Ticket**... (Usually Takes 2-4 Seconds)`, ephemeral: true}).catch(e => {console.warn(e.stack ? String(e.stack).grey : String(e).grey)});
                        ////////////////////////
                        /////////////////////////
                        Cooldown.set(user.id, Date.now())
                        setTimeout(()=>Cooldown.delete(user.id), cooldownamount);
                        
                        let ticket = client.setups.get(guild.id, "ticketsystem1");
                        if (!ticket.enabled) return interaction.editReply(":x: **Sorry but we are currently not providing __System Bots__!**").catch(e => console.warn(e.stack ? String(e.stack).grey : String(e).grey));
                        var stopped = false;
                        if (client.setups.get("TICKETS", "tickets").includes(user.id)) {
                            try{
                            let ch = guild.channels.cache.get(client.setups.get(user.id, "ticketid"));
                            if(!ch || ch == null || !ch.id || ch.id == null || [`${mainconfig.TicketCategorys.SystemBotOrderCategory}`, `${mainconfig.TicketCategorys.SystemBotOrderCategory}`].includes(ch.parentId)){                                client.setups.remove("TICKETS", user.id, "tickets2")
                            client.setups.remove("TICKETS", user.id, "tickets")    
                            } else {
                                stopped = true;
                                return interaction.editReply(":x: **You already have an opened System-Bot-Order-Ticket!!** <#" + client.setups.get(user.id, "ticketid") + ">").catch(e => {console.warn(e.stack ? String(e.stack).grey : String(e).grey)});
                            }
                            }catch{
                        ...
                        */
                        ...
                        guild.channels.create(channelname.substring(0, 32), {
                            //parent: parentId,
                            parent: `${mainconfig.TicketCategorys.SystemBotOrderCategory}`,
                            ...
                            components: [
                                ...
                                if(interaction.message.channel.id == RecoverChannelId) msg.reply(`<:Approved:1079215640944070697> **This is a REFUND ORDER**`).catch(() => {});
                            })
                    ...
                    case "MusicBots" : {
                        ...
                        if (client.setups.get("TICKETS", "tickets2").includes(user.id)) {
                            ...
                            if(!ch || ch == null || !ch.id || ch.id == null || [`${mainconfig.TicketCategorys.MusicBotOrderCategory}`, `${mainconfig.TicketCategorys.MusicBotOrderCategory}`].includes(ch.parentId)){
                                client.setups.remove("TICKETS", user.id, "tickets2")
                            client.setups.remove("TICKETS", user.id, "tickets2")    
                            } else {
                                stopped = true;
                        ...
                        guild.channels.create(channelname.substring(0, 32), {
                            parent: `${mainconfig.TicketCategorys.MusicBotOrderCategory}`,
                            topic: `ticket-${user.id}`
                        }).then(ch => {
                            ch.permissionOverwrites.edit(guild.roles.everyone, { //disabling all roles
                                SEND_MESSAGES: false,
                            ...
                            ch.send({content: `<@${user.id}> <:arrow:1079211960199028796>  ${ticket.adminroles.map(r => `<@&${r}>`).join(" | ")} ${emoji.arrow_left} `, 
                            embeds: [new MessageEmbed().setColor("#6861fe")
                    ...
                    case "RYTHMCLONE" : {
                        ...
                        if (client.setups.get("TICKETS", "tickets3").includes(user.id)) {
                            ...
                            if(!ch || ch == null || !ch.id || ch.id == null || [`${mainconfig.TicketCategorys.RythmBotTicketsCategory}`, `${mainconfig.TicketCategorys.RythmBotTicketsCategory}`].includes(ch.parentId)){
                                client.setups.remove("TICKETS", user.id, "tickets3")
                            }
                            else{
                                stopped = true;
                                return interaction.editReply(":x: **You already have an opened Rythm-Clone-Order-Ticket!** <#" + client.setups.get(user.id, "ticketid4") + ">").catch(e => {console.warn(e.stack ? String(e.stack).grey : String(e).grey)});
                            }
                            }catch{
                        ...
                        guild.channels.create(channelname.substring(0, 32), {
                            parent: `${mainconfig.TicketCategorys.RythmBotTicketsCategory}`,
                            topic: `ticket-${user.id}`
                        }).then(ch => {
                            ch.permissionOverwrites.edit(guild.roles.everyone, { //disabling all roles
                                SEND_MESSAGES: false,
                    ...
                    case "LIGHT_MUSIC_BOT" : {
                        ...
                        if (!ticket.enabled) return interaction.editReply(":x: **Sorry but we are currently not providing __LightMusicBot Bots__!**").catch(e => console.warn(e.stack ? String(e.stack).grey : String(e).grey));
                        var stopped = false;
                        if (client.setups.get("TICKETS", "tickets4").includes(user.id)) {
                            ...
                            if(!ch || ch == null || !ch.id || ch.id == null || [`${mainconfig.TicketCategorys.LightMusicBotOrderCategory}`, `${mainconfig.TicketCategorys.LightMusicBotOrderCategory}`].includes(ch.parentId)){
                                client.setups.remove("TICKETS", user.id, "tickets4")
                            }
                            else{
                                stopped = true;
                                return interaction.editReply(":x: **You already have an opened LightMusicBot-Bot-Order-Ticket!** <#" + client.setups.get(user.id, "ticketid3") + ">").catch(e => {console.warn(e.stack ? String(e.stack).grey : String(e).grey)});
                            }
                            }catch{
                        ...
                        guild.channels.create(channelname.substring(0, 32), {
                            parent: `${mainconfig.TicketCategorys.LightMusicBotOrderCategory}`,
                            topic: `ticket-${user.id}`
                        }).then(ch => {
                            ch.permissionOverwrites.edit(guild.roles.everyone, { //disabling all roles
                                SEND_MESSAGES: false,
                            ...
                            ch.send({content: `<@${user.id}> <:arrow:1079211960199028796>  ${ticket.adminroles.map(r => `<@&${r}>`).join(" | ")} ${emoji.arrow_left} `, embeds: [new MessageEmbed().setColor("#6861fe")
                            .setTitle(`<:Public_LightMusicBot:1096471832678375565> for Ordering a LightMusicBot Bot! Send the Parameters!`)
                            .setDescription(ticket.message.replace("{user}", `${user}`)),
                            new MessageEmbed().setColor("YELLOW").setTitle(`${emoji.loading} A Staff Member will claim the Ticket soon!`).setDescription(`**Dear ${user}!**\n> This Ticket will be claimed by a Staff Member as soon as possible!\n\n> *He/She/They will help you then!*\n\n> **Meanwhile, make sure to list us all Information needed!**`).setFooter("Thanks for choosing Team Arcades ✌️", "https://i.imgur.com/UnHkdfP.png")],
                            components: [
                                new MessageActionRow().addComponents([
                            ...
                            interaction.editReply({content: `<#${ch.id}>`, embeds: [new MessageEmbed()
                                .setColor("#6861fe")
                                .setTitle(`<:Public_LightMusicBot:1096471832678375565> Your LightMusicBot Bot Order \`${ch.name}\` has been created!`)
                                .addField("💢 ATTENTION", `> *Please make sure, to fill out the Information the Bot sent you in the CHANNEL*`)
                                .addField("💬 The Channel:",`<#${ch.id}>`)], ephemeral: true}).then(msg=>{
                            }).catch(e => {console.warn(e.stack ? String(e.stack).grey : String(e).grey)});            
                        }).catch(e => {console.warn(e.stack ? String(e.stack).grey : String(e).grey)});
                    ...
                    case "ADMINISTRATIONBOT" : {
                        await interaction.reply({content: `<a:Loading:1075485750000361523> **Creating Your Ticket**... (Usually Takes 2-4 Seconds) `, ephemeral: true})
                        ////////////////////////
                        /////////////////////////
                        Cooldown.set(user.id, Date.now())
                        setTimeout(()=>Cooldown.delete(user.id), cooldownamount);
                        ...
                        if (client.setups.get("TICKETS", "tickets5").includes(user.id)) {
                            ...
                            if(!ch || ch == null || !ch.id || ch.id == null || [`${mainconfig.TicketCategorys.AdminBotTicketsCategory}`, `${mainconfig.TicketCategorys.AdminBotTicketsCategory}`].includes(ch.parentId)){
                                client.setups.remove("TICKETS", user.id, "tickets5")
                            }
                            else{
                                stopped = true;
                        ...
                        guild.channels.create(channelname.substring(0, 32), {
                            parent: `${mainconfig.TicketCategorys.AdminBotTicketsCategory}`,
                            topic: `ticket-${user.id}`
                        }).then(ch => {
                            ch.permissionOverwrites.edit(guild.roles.everyone, { //disabling all roles
                                SEND_MESSAGES: false,
                    ...
                    case "24_7_MUSIC_BOT" : {
                        ...
                        if (client.setups.get("TICKETS", "tickets6").includes(user.id)) {
                            ...
                            if(!ch || ch == null || !ch.id || ch.id == null || [`${mainconfig.TicketCategorys.MusicBotOrderCategory}`, `${mainconfig.TicketCategorys.MusicBotOrderCategory}`].includes(ch.parentId)){
                                ...
                                stopped = true;
                                return interaction.editReply(":x: **You already have an opened 24/7-Music-Bot-Order-Ticket!** <#" + client.setups.get(user.id, "ticketid6") + ">").catch(e => {console.warn(e.stack ? String(e.stack).grey : String(e).grey)});
                            }
                            }catch{
                    ...
                    case "MODMAILBOT": {
                        ...
                        if (client.setups.get("TICKETS", "tickets7").includes(user.id)) {
                            ...
                            if(!ch || ch == null || !ch.id || ch.id == null || [`${mainconfig.TicketCategorys.ModMailBotTicketsCategory}`, `${mainconfig.TicketCategorys.ModMailBotTicketsCategory}`].includes(ch.parentId)){
                                ...
                                stopped = true;
                                return interaction.editReply(":x: **You already have an opened Mod-Mail-Bot-Order-Ticket!** <#" + client.setups.get(user.id, "ticketid7") + ">").catch(e => {console.warn(e.stack ? String(e.stack).grey : String(e).grey)});
                            }
                            }catch{
                    ...
                    case "LAVAMUSICBOT": {
                        ...
                        if (client.setups.get("TICKETS", "tickets8").includes(user.id)) {
                            ...
                            if(!ch || ch == null || !ch.id || ch.id == null || [`${mainconfig.TicketCategorys.MusicBotOrderCategory}`, `${mainconfig.TicketCategorys.MusicBotOrderCategory}`].includes(ch.parentId)){
                                ...
                                stopped = true;
                                return interaction.editReply(":x: **You already have an opened Lava-Music-Bot-Order-Ticket!** <#" + client.setups.get(user.id, "ticketid8") + ">").catch(e => {console.warn(e.stack ? String(e.stack).grey : String(e).grey)});
                            }
                            }catch{
                        ...
                        guild.channels.create(channelname.substring(0, 32), {
                            ...
                            interaction.editReply({content: `<#${ch.id}>`, embeds: [new MessageEmbed()
                                .setColor("#6861fe")
                                .setTitle(`<:LavaMusic:1079545573880909824> Your Lava Music Bot Order \`${ch.name}\` has been created!`)
                                .addField("💢 ATTENTION", `> *Please make sure, to fill out the Information the Bot sent you in the CHANNEL*`)
                                .addField("💬 The Channel:",`<#${ch.id}>`)], ephemeral: true}).then(msg=>{
                                }).catch(e => {console.warn(e.stack ? String(e.stack).grey : String(e).grey)}); 
                        })
                    ...
                    //ticketsystem9
                    case "SECURITYBOT": {
                        await interaction.reply({content: `<:Super_Mod:1079215692236202084> <a:Loading:1075485750000361523> **Creating Your Ticket**... (Usually Takes 2-4 Seconds)`, ephemeral: true})
                        ////////////////////////
                        /////////////////////////
                        Cooldown.set(user.id, Date.now())
                        setTimeout(()=>Cooldown.delete(user.id), cooldownamount);
                        ...
                        if (client.setups.get("TICKETS", "tickets9").includes(user.id)) {
                            ...
                            if(!ch || ch == null || !ch.id || ch.id == null || [`${mainconfig.TicketCategorys.SecurityTicketsCategory}`, `${mainconfig.TicketCategorys.SecurityTicketsCategory}`].includes(ch.parentId)){
                                client.setups.remove("TICKETS", user.id, "tickets9")
                            }
                            else{
                                stopped = true;
                                return interaction.editReply(":x: **You already have an opened Security-Bot-Order-Ticket!** <#" + client.setups.get(user.id, "ticketid9") + ">").catch(e => {console.warn(e.stack ? String(e.stack).grey : String(e).grey)});
                            }
                            }catch{
                        ...
                        guild.channels.create(channelname.substring(0, 32), {
                            parent: `${mainconfig.TicketCategorys.SecurityTicketsCategory}`,
                            topic: `ticket-${user.id}`
                        }).then(ch => {
                            ch.permissionOverwrites.edit(guild.roles.everyone, { //disabling all roles
                                SEND_MESSAGES: false,
                            ...
                            ch.send({content: `<@${user.id}> <:arrow:1079211960199028796>  ${ticket.adminroles.map(r => `<@&${r}>`).join(" | ")} ${emoji.arrow_left} `, embeds: [new MessageEmbed().setColor("#6861fe")
                            .setTitle(`<:Super_Mod:1079215692236202084> Thanks for Ordering a Security Bot! Send the Parameters!`)
                            .setDescription(ticket.message.replace("{user}", `${user}`)),                                new MessageEmbed().setColor("YELLOW").setTitle(`${emoji.loading} A Staff Member will claim the Ticket soon!`).setDescription(`**Dear ${user}!**\n> This Ticket will be claimed by a Staff Member as soon as possible!\n\n> *He/She/They will help you then!*\n\n> **Meanwhile, make sure to list us all Information needed!**`).setFooter("Thanks for choosing Team Arcades ✌️", "https://i.imgur.com/UnHkdfP.png")],
                            components: [
                                new MessageActionRow().addComponents([
                                    new MessageButton().setStyle("PRIMARY").setLabel("Claim").setEmoji("📝").setCustomId("TicketClaim")
                            ...
                            interaction.editReply({content: `<#${ch.id}>`, embeds: [new MessageEmbed()
                                .setColor("#6861fe")
                                .setTitle(`<:Super_Mod:1079215692236202084> Your Security Bot Order \`${ch.name}\` has been created!`)
                                .addField("💢 ATTENTION", `> *Please make sure, to fill out the Information the Bot sent you in the CHANNEL*`)
                                .addField("💬 The Channel:",`<#${ch.id}>`)], ephemeral: true}).then(msg=>{
                                }).catch(e => {console.warn(e.stack ? String(e.stack).grey : String(e).grey)}); 
                        })
                    ...
                    case "NSFW_AND_FUN_BOT": {
                        await interaction.reply({content: `🕹️ <a:Loading:1075485750000361523> **Creating Your Ticket**... (Usually Takes 2-4 Seconds)`, ephemeral: true})
                        ////////////////////////
                        /////////////////////////
                        Cooldown.set(user.id, Date.now())
                        setTimeout(()=>Cooldown.delete(user.id), cooldownamount);
                        ...
                        if (client.setups.get("TICKETS", "tickets10").includes(user.id)) {
                            ...
                            if(!ch || ch == null || !ch.id || ch.id == null || [`${mainconfig.TicketCategorys.NsfwFunBotTicketsCategory}`, `${mainconfig.TicketCategorys.NsfwFunBotTicketsCategory}`].includes(ch.parentId)){
                                client.setups.remove("TICKETS", user.id, "tickets10")
                            }
                            else{
                                stopped = true;
                                return interaction.editReply(":x: **You already have an opened NSFW-&-FUN-Bot-Order-Ticket!** <#" + client.setups.get(user.id, "ticketid10") + ">").catch(e => {console.warn(e.stack ? String(e.stack).grey : String(e).grey)});
                            }
                            }catch{
                        ...
                        guild.channels.create(channelname.substring(0, 32), {
                            parent: `${mainconfig.TicketCategorys.NsfwFunBotTicketsCategory}`,
                            topic: `ticket-${user.id}`
                        }).then(ch => {
                            ch.permissionOverwrites.edit(guild.roles.everyone, { //disabling all roles
                                SEND_MESSAGES: false,
